...
class enviar_mail_solicitud implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct(private String $ruta,private Cliente $get_cliente)
    {
        //
    }
    ...
    public function handle()
    {
        ...
        foreach ($gerentes as $gerente) {
            ...
            $cliente = $this->get_cliente->cli_nombre . ' | ' . $this->get_cliente->cli_apellido;

            Mail::send('correo.prestamo_pediente', [
                "ruta" => $this->ruta,
                "cliente" => $cliente,
