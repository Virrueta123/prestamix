        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <a href="" class="-intro-x flex items-center pt-5">
                    <img alt="Midone - HTML Admin Template" class="w-6" src="dist/images/logo/logotipo.svg">
               <span class="text-white text-lg ml-3"> CASH TIME </span>
                </a>
                <div class="my-auto">
                    ...
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">Gestion de los prestamos con mayor eficiencia</div>
                </div>
            </div>
            <!-- END: Login Info -->
            <!-- BEGIN: Login Form -->
                ...
                <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                    ...
                    <div
                        ...
                        <div class="intro-x mt-8">
                            <input type="text" class="intro-x login__input form-control py-3 px-4 block @error('email') is-invalid @enderror"
                                ...
                                @enderror
                            <input type="password" class="intro-x login__input form-control py-3 px-4 block mt-4 @error('password') is-invalid @enderror"
                                placeholder="Constraseña" name="password"
                        ...
                        <div class="intro-x mt-10 xl:mt-24 text-slate-600 dark:text-slate-500 text-center xl:text-left">
                            Para obtener acceso como usuario, es necesario solicitar autorización al gerente de la empresa </div>
                    </div>
