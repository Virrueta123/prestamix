...
<foreignObject transform="matrix(1 0 0 1 37.0645 50)" width="508" height="97">
    <div class="text-normal" style="text-align: justify;">
        ...
        <text x="0" y="10" textAnchor="start">
            ...
            Cumplido el requisito de mora, <tspan class="text-negrita">EL MUTUANTE</tspan> se encuentra facultado a ejercer las acciones legales
            correspondientes para hacer cumplir el compromiso de la deuda asumida por <tspan class="text-negrita">EL MUTUATARIO</tspan>, dentro de dicho
            ...
            dinero, medidas de embargo para lo cual deja su número de cuenta N° …………………………………………………… y otras de
            naturaleza similar.
...
<div class="separador-mayor" style="margin-bottom: 260px;"></div>
