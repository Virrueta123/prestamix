    ...
    <foreignObject transform="matrix(1 0 0 1 37.0645 365)" width="508" height="97">
        <div class="text-normal" style="text-align: justify;">
            ...
            <text x="0" y="10" textAnchor="start">
                ...
                Ambas partes convienen en que el presente contrato de mutuo se celebra a título oneroso, en
                consecuencia, <tspan class="text-negrita">EL MUTUATARIO</tspan> está obligado al pago de intereses
                compensatorios en favor de <tspan class="text-negrita">EL MUTUANTE,</tspan>
    ...
    <foreignObject transform="matrix(1 0 0 1 37.0645 365)" width="508" height="97">
        <div class="text-normal" style="text-align: justify;">
            ...
            <text x="0" y="10" textAnchor="start">
                ...
                {{ $interes_deletreado }} por ciento ({{ $interes }}%) del importe cedido en calidad de préstamo, es decir que
                se calcula sobre el íntegro del
