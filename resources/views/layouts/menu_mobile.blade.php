<ul class="scrollable__content py-2">
    ...
    <li>
        ...
        <ul>
            ...
            <li>
                <a href="{{ route('cliente.clientes_que_pagan') }}" class="menu">
                    <div class="menu__icon"> <i class="fa-solid fa-hand-holding-dollar"></i> </div>
                    <div class="menu__title"> Clientes que pagan </div>
                </a>
            </li>
        </ul>
    </li>
