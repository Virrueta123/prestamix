<template>
    ...
    <div class="intro-y box mt-5">
        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60">
            <h2 class="font-medium text-base mr-auto">
                Tabla de solicitudes para los trabajadores
            </h2>
        </div>
    ...
    <Sidebar v-model:visible="is_opciones_modal" header="Opciones para la tabla de solicitudes" position="bottom"
        ...
        <div id="link-button" class="p-5">
            ...
            <a :href="'/tabla_solicitud/' + get_solicitud.urlapi" class="btn btn-eye  mr-1 mb-2">
                <Icon icon='eye' class='mr-2' /> Ver solicitud trabajador
            </a> 
        </div>
    ...
    methods: {
        async load_user_data() {
            ...
            var table = $('#table_solicitud_trabajador').DataTable({
                ...
                ajax: {
                    url: '/tabla_solicitud_trabajadores',
                    type: 'post',
                    async: true,
                },
                "order": [[5, "desc"]],
