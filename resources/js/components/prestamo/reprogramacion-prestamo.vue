<template>
    ...
    <div class="card box p-3 mt-3">
        ...
        <div class="grid grid-cols-12 gap-6 mt-2">
            ...
            <div class="intro-y col-span-12 mr-4 lg:col-span-3">
...
export default {
    ...
    methods: {
        ...
        crear_reporgramacion() {
            ...
            if (this.isSubmitExecution == true) return;

            this.isSubmitting = true; // marcar que está en ejecución
            ...
            Axios
                ...
                .catch((error) => {
                    this.alert_error_modal("Error en el servidor, intente nuevamente");
                    console.error(error);
                }).finally(() => {
                    this.loading_end();
