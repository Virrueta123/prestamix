<template>
        ...
        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
            <div class="xl:flex sm:mr-auto mt-2 pt-0">
                <div class="font-bold text-base  font-xl">
                    <h1 class=" font-xl">AMPLIACIÓN</h1>
                </div>
            </div>
            <div class="xl:flex sm:mr-auto mt-2 pt-0">
    ...
    <div class="card box p-3 mt-3">
        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
            <div class="xl:flex sm:mr-auto mt-2 pt-0">
                <div class="font-bold text-base  font-xl"> Ampliacion de prestamo </div>
            </div>
            <div class="flex mt-5 sm:mt-0">
                <button v-if="is_reprogramacion" @click="calcular_cronograma()" type="button" name="" id=""
                    class="btn btn-primary btn-sm btn-block">
                    <i class="fa fa-calendar-days mr-2"></i>
                    Calcular Cronograma de la Ampliacion
                </button>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-12 gap-6 mt-2">
            <div class="intro-y col-span-12 lg:col-span-4">
                ...
                <div class="input-group">
                    ...
                    <InputNumber class="form-control p-2 border border-success" v-model="monto_credito_amortizacion"
                        placeholder="Monto del credito" inputId="locale-us" locale="en-US" :minFractionDigits="2" />

                </div>
            </div>

            <div class="intro-y col-span-12 lg:col-span-4">
                <label for="vertical-form-2" class="form-label">Monto de credito para ampliar</label>
                <div class="input-group">
                    <div id="input-group-email" class="input-group-text">S/.</div>



                    <InputNumber class="form-control p-2 border border-success" v-model="monto_credito_nueva"
                        name="monto_credito_nueva" placeholder="Monto del credito" inputId="locale-us" locale="en-US"
                        :minFractionDigits="2" />
            ...
            <div class="intro-y col-span-12 lg:col-span-4">
                ...
                <div class="input-group">
                    ...
                    <InputNumber class="form-control p-2 border border-success" v-model="monto_credito"
                        name="monto_credito" placeholder="Monto del credito" inputId="locale-us" locale="en-US"
                        :minFractionDigits="2" />
                </div>
            </div>
        </div>
        ...
        <div v-if="frecuencia_pagos == 'Mensual'">
            ...
            <div class=" col-span-12 lg:col-span-12 mt-3" v-if="is_fecha_pago">
                ...
                <datepicker class="form-control col-span-12" v-on:change="change_fecha_de_pago_cuota()"
                    ...
                    :styles="{ border: '2px solid #00ff00' }" :disabled-dates="rango_maximo" language="es"></datepicker>
            </div>
        </div>
    ...
    <button v-if="is_boton" @click="crear_ampliacion()" type="submit"
...
export default {
    ...
    data() {
        return {
            ...
            // opcion para cambiar la fecha de las cuotas
            is_fecha_pago: false,
    ...
    watch: {
        ...
        'fecha_de_pago_cuota': function (newValue) {
            this.is_boton = false;
            console.log("nueva fecha de pago: " + this.fecha_de_pago_cuota);
    ...
    methods: {
        // evento que se ejucutara cuando se selecciona un fecha de cuota
        change_fecha_de_pago_cuota() {
            console.log("nueva fecha de pago: " + this.fecha_de_pago_cuota); 
        },
        ...
        crear_ampliacion() {
            const data = {
                ...
                monto_credito_nueva: this.monto_credito_nueva,
        ...
        calcular_cronograma() {
            ...
            if (this.is_fecha_pago) {
                console.log(this.fecha_de_pago_cuota);
    ...
    mounted() {
        ...
        var fecha_actual = moment().add(1, 'days');
        ...
        this.monto_credito_nueva = 0;
        this.monto_credito = this.monto_credito_amortizacion;
