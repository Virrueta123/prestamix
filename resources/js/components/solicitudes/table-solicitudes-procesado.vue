    ...
    <div class="intro-y box mt-5">
        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60">
            <h2 class="font-medium text-base mr-auto">
                Tabla de solicitudes procesados
            </h2>
        </div>
        <div class="p-5" id="small-table">
            <div class="preview" style="display: block;">
                <div class="overflow-x-auto">
                    <table class="table " id="table_solicitud_procesado">
                        <thead>
                            <tr>
                                <th>E.Prestamo</th>
                                <th>Serie</th>
...
export default {
    ...
    methods: {
        async load_user_data() {
            ...
            this.table_solicitud = $('#table_solicitud_procesado').DataTable({
                language: this.spanish_datatable,
                ajax: {
                    url: '/tabla_solicitud_procesado_data',
                    type: 'post',
                    async: true,
                },
                columns: [
                    {
                        ...
                        render: function (data, type, row) {
                            if (row.prestamo !== null) {
                                switch (row.prestamo.status) {
            ...
            var self = this;
            $('#table_solicitud_procesado tbody').on('dblclick', 'tr', function () {
