        ...
        <div id="basic-button" class="p-1 mt-4">
            <div class="preview">
                <button v-on:click="actualizar_pago()" v-if="is_created && !isLoading" type="submit"
                    ...
                    <Icon icon="plus" class="ml-2" /> Editar gasto
                </button>
...
export default {
    ...
    mounted() {
        ...
        this.monto = this.get_gasto.monto;

        console.log(this.get_gasto);
        let numero = 0;

        this.get_gasto.pago.forEach(element => {
            numero++;
            console.log(element);
            this.pagos.push({
